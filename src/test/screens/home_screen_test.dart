...
void main() {
  group('HomeScreen Widget Tests', () {
    ...
    testWidgets('increments counter when increment button is pressed',
        (WidgetTester tester) async {
      final mockCubit = MockCounterCubit();
      when(() => mockCubit.state).thenReturn(CounterState(counter: 1));
    ...
    testWidgets('decrements counter when decrement button is pressed',
        (WidgetTester tester) async {
      final mockCubit = MockCounterCubit();
      when(() => mockCubit.state).thenReturn(CounterState(counter: -1));
